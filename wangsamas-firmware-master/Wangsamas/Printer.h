...
#define HOME_DISTANCE_MM (HOME_DISTANCE_STEPS * invaxisStepsPerUnit[Z_AXIS])
...
public:
    ...
    static float axisStepsPerUnit[];
    static float invaxisStepsPerUnit[];
...
//	static float sqFarm;				// Kusuma Scara
	...
	static float ElbowMaxAngle;			// Kusuma Scara
	static float ShoulderBedCenterAngle;// Kusuma Scara
	static float ElbowBedCenterAngle;	// Kusuma Scara
	static float BedCenterXpos;			// Kusuma Scara
	static float BedCenterYpos;			// Kusuma Scara
	static float ScaraBedDistance;		// Kusuma Scara
	static float ScaraEndstopPosX;		// Kusuma Scara
	static float ScaraEndstopPosY;		// Kusuma Scara
	static float squaredscaraMinRadius;	// Kusuma Scara
	static float squaredscaraMaxRadius;	// Kusuma Scara
    static float deltaAPosX;
    static float deltaAPosY;
    static float deltaBPosX;
    static float deltaBPosY;
    ...
    static int32_t deltaDPosXSteps;	// Kusuma SCARA
    static int32_t deltaDPosYSteps;	// Kusuma SCARA
    ...
    static void closeArm(bool xaxis,bool yaxis,bool zaxis); /// Home axis
#endif
    ...
    static void MeasureStepToEndstop(float feedrate);
#endif
