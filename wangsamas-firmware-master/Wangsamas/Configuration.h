...
#define XAXIS_STEPS_PER_UNIT 135		// Cartesian Steps/mm, Delta abaikan, Scara Steps/degree
#define YAXIS_STEPS_PER_UNIT 109		// Cartesian Steps/mm, Delta abaikan, Scara Steps/degree
#define ZAXIS_STEPS_PER_UNIT 200	// Cartesian Steps/mm, Delta Steps/mm, Scara Steps/mm

// Scara Setting
#define ARM_LENGTH 200					      // dalam mm. in mm
#define FOREARM_LENGTH 203			    	// dalam mm. in mm
#define SHOULDER_MIN_ANGLE 0		    	// dalam derajat. in degree 
#define ELBOW_MIN_ANGLE -145				      // dalam derajat. in degree
#define SHOULDER_MAX_ANGLE 360			  // dalam derajat. in degree
#define ELBOW_MAX_ANGLE 145				    // dalam derajat. in degree
#define SHOULDER_BED_CENTER_ANGLE 180	// Posisi sudut bahu Scara di pusat papan dalam derajat. Position of Scara shoulder angle at bed center in degree
#define ELBOW_BED_CENTER_ANGLE 45		  // Posisi sudut siku Scara di pusat papan dalam derajat. Position of Scara elbow angle at bed center in degree
