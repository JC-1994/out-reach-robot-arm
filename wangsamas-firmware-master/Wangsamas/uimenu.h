...
/*
  ...
  steps
  %Sx : steps per unit x direction
  %Sy : steps per unit y direction
  %Sz : steps per unit z direction
  %Se : steps per unit current extruder
...
#if HAVE_HEATED_BED
#if NUM_EXTRUDER > 0
//   UI_PAGE4(ui_page1,cTEMP "%ec/%Ec" cDEG "B%eB/%Eb" cDEG,"Z:%x2  Buf : %oB","Spd: %om   Flow: %of","%os")
...
#else
//   UI_PAGE4(ui_page1,"B%eB/%Eb" cDEG,"Z:%x2  Buf : %oB","Spd: %om   Flow: %of","%os")
...
#if LANGUAGE_IN_ACTIVE
UI_MENU_ACTIONCOMMAND(ui_menu_setlang_in, "Indonesia", UI_ACTION_LANGUAGE_IN | UI_ACTION_TOPMENU) // Indonesia
#if FIRSTLANG
#define ADD_LANG_IN &ui_menu_setlang_in
#undef FIRSTLANG
#define FIRSTLANG 0
#else
#define ADD_LANG_IN ,&ui_menu_setlang_in
...
#else
#define ADD_LANG_IN
#endif // LANGUAGE_IN_ACTIVE // Indonesia

#define UI_MENU_LANGUAGES {UI_MENU_ADDCONDBACK ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR ADD_LANG_IN} // Indonesia
#define UI_MENU_LANGUAGES_WIZ {ADD_LANG_EN ADD_LANG_DE ADD_LANG_ES ADD_LANG_PT ADD_LANG_FR ADD_LANG_NL ADD_LANG_IT ADD_LANG_FI ADD_LANG_SE ADD_LANG_CZ ADD_LANG_PL ADD_LANG_TR ADD_LANG_IN} // Indonesia
UI_MENU(ui_menu_languages, UI_MENU_LANGUAGES, UI_MENU_BACKCNT + LANGUAGE_EN_ACTIVE + LANGUAGE_DE_ACTIVE + LANGUAGE_ES_ACTIVE + LANGUAGE_PT_ACTIVE + LANGUAGE_FR_ACTIVE + LANGUAGE_NL_ACTIVE + LANGUAGE_IT_ACTIVE + LANGUAGE_FI_ACTIVE + LANGUAGE_SE_ACTIVE + LANGUAGE_CZ_ACTIVE + LANGUAGE_PL_ACTIVE + LANGUAGE_TR_ACTIVE + LANGUAGE_IN_ACTIVE) // Indonesia
...
UI_MENU_ACTION4_T(ui_menu_yangle_notest, UI_ACTION_YROTATION_NOTEST, UI_TEXT_ACTION_YROTATION4A_ID, UI_TEXT_ACTION_YROTATION4B_ID, UI_TEXT_ACTION_YROTATION4C_ID, UI_TEXT_ACTION_YROTATION4D_ID)
UI_MENU_ACTION4_T(ui_menu_x_angle_fast, UI_ACTION_XROTATION_FAST, UI_TEXT_ACTION_XFAST_ROTATION4A_ID, UI_TEXT_ACTION_XFAST_ROTATION4B_ID, UI_TEXT_ACTION_XFAST_ROTATION4C_ID, UI_TEXT_ACTION_XFAST_ROTATION4D_ID)
UI_MENU_ACTION4_T(ui_menu_y_angle_fast, UI_ACTION_YROTATION_FAST, UI_TEXT_ACTION_YFAST_ROTATION4A_ID, UI_TEXT_ACTION_YFAST_ROTATION4B_ID, UI_TEXT_ACTION_YFAST_ROTATION4C_ID, UI_TEXT_ACTION_YFAST_ROTATION4D_ID)
UI_MENU_ACTION4_T(ui_menu_xangle_fast_notest, UI_ACTION_XROTATION_FAST_NOTEST, UI_TEXT_ACTION_XFAST_ROTATION4A_ID, UI_TEXT_ACTION_XFAST_ROTATION4B_ID, UI_TEXT_ACTION_XFAST_ROTATION4C_ID, UI_TEXT_ACTION_XFAST_ROTATION4D_ID)
UI_MENU_ACTION4_T(ui_menu_yangle_fast_notest, UI_ACTION_YROTATION_FAST_NOTEST, UI_TEXT_ACTION_YFAST_ROTATION4A_ID, UI_TEXT_ACTION_YFAST_ROTATION4B_ID, UI_TEXT_ACTION_YFAST_ROTATION4C_ID, UI_TEXT_ACTION_YFAST_ROTATION4D_ID)
#endif						// Kusuma SCARA
...
UI_MENU_ACTION2_T(ui_menu_yangle_notest, UI_ACTION_YROTATION_NOTEST, UI_TEXT_ACTION_YROTATION2A_ID, UI_TEXT_ACTION_YROTATION2B_ID)
UI_MENU_ACTION2_T(ui_menu_x_angle_fast, UI_ACTION_XROTATION_FAST, UI_TEXT_ACTION_XFAST_ROTATION2A_ID, UI_TEXT_ACTION_XFAST_ROTATION2B_ID)
UI_MENU_ACTION2_T(ui_menu_y_angle_fast, UI_ACTION_YROTATION_FAST, UI_TEXT_ACTION_YFAST_ROTATION2A_ID, UI_TEXT_ACTION_YFAST_ROTATION2B_ID)
UI_MENU_ACTION2_T(ui_menu_xangle_fast_notest, UI_ACTION_XROTATION_FAST_NOTEST, UI_TEXT_ACTION_XFAST_ROTATION2A_ID, UI_TEXT_ACTION_XFAST_ROTATION2B_ID)
UI_MENU_ACTION2_T(ui_menu_yangle_fast_notest, UI_ACTION_YROTATION_FAST_NOTEST, UI_TEXT_ACTION_YFAST_ROTATION2A_ID, UI_TEXT_ACTION_YFAST_ROTATION2B_ID)
#endif						// Kusuma SCARA	
...
UI_MENU_ACTIONSELECTOR_T(ui_menu_rotate_y_notest, UI_TEXT_Y_ANGLE_POS_ID, ui_menu_yangle_notest)
#endif																						// Kusuma SCARA	
...
UI_MENU_ACTIONSELECTOR_T(ui_menu_rotate_yfast_notest, UI_TEXT_Y_ANGLE_FAST_ID, ui_menu_yangle_fast_notest)
#endif																							// Kusuma SCARA
...
#define UI_SPEED_ROT_Y_NOTEST &ui_menu_rotate_yfast_notest,&ui_menu_rotate_y_notest,  // Kusuma SCARA
#endif
...
#define UI_SPEED_ROT_Y_NOTEST &ui_menu_rotate_y_notest, // Kusuma SCARA
#endif
...
UI_MENU_ACTIONCOMMAND_T(ui_menu_set_elbow_origin, UI_TEXT_SET_ELBOW_ORIGIN_ID, UI_ACTION_SET_ELBOW_ORIGIN)
#define UI_MENU_ELBOW {UI_MENU_ADDCONDBACK &ui_menu_home_all, UI_SPEED_ROT_Y_NOTEST &ui_menu_set_elbow_origin}
UI_MENU(ui_menu_elbow, UI_MENU_ELBOW, 2 + UI_SPEED + UI_MENU_BACKCNT) // Kusuma SCARA
#endif
...
#define UI_MENU_LEVEL {UI_MENU_ADDCONDBACK &ui_menu_set_p1,&ui_menu_set_p2,&ui_menu_set_p3, UI_SPEED_X UI_SPEED_Y UI_SPEED_Z &ui_menu_calculate_leveling}
...
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_preheat_pla, UI_TEXT_PREHEAT_PLA_ID, UI_ACTION_PREHEAT_PLA | UI_ACTION_TOPMENU)
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_preheat_abs, UI_TEXT_PREHEAT_ABS_ID, UI_ACTION_PREHEAT_ABS | UI_ACTION_TOPMENU)
...
UI_MENU(ui_menu_debug, UI_MENU_DEBUGGING, 5 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_debugging, UI_TEXT_DEBUGGING_ID, ui_menu_debug)
...
#define UI_MENU_ELBOW_COND ,&ui_menu_conf_elbow
#define UI_MENU_ELBOW_CNT 1
UI_MENU_SUBMENU_T(ui_menu_conf_elbow, UI_TEXT_ELBOW_CALIB_ID, ui_menu_elbow)
#endif										// Kusuma SCARA
...
UI_MENU_CHANGEACTION_T(ui_menu_rot_y_fast, UI_TEXT_ACTION_YFAST_ROTATION4A_ID, UI_ACTION_YROTATION_FAST)
UI_MENU_CHANGEACTION_T(ui_menu_rot_x_fast, UI_TEXT_ACTION_XFAST_ROTATION4A_ID, UI_ACTION_XROTATION_FAST)
UI_MENU_CHANGEACTION_T(ui_menu_move_z_fast, UI_TEXT_ACTION_ZPOSITION_FAST4A_ID, UI_ACTION_ZPOSITION_FAST)
UI_MENU_CHANGEACTION_T(ui_menu_move_y_fast, UI_TEXT_ACTION_YPOSITION_FAST4A_ID, UI_ACTION_YPOSITION_FAST)
UI_MENU_CHANGEACTION_T(ui_menu_move_x_fast, UI_TEXT_ACTION_XPOSITION_FAST4A_ID, UI_ACTION_XPOSITION_FAST)

UI_MENU_CHANGEACTION_T(ui_menu_e_step, UI_TEXT_E_STEP_ID, UI_ACTION_E_STEP)
UI_MENU_CHANGEACTION_T(ui_menu_z_step, UI_TEXT_Z_STEP_ID, UI_ACTION_Z_STEP)
UI_MENU_CHANGEACTION_T(ui_menu_y_step, UI_TEXT_Y_STEP_ID, UI_ACTION_Y_STEP)
UI_MENU_CHANGEACTION_T(ui_menu_x_step, UI_TEXT_X_STEP_ID, UI_ACTION_X_STEP)

UI_MENU_ACTIONCOMMAND_T(ui_menu_set_bed_center, UI_TEXT_SET_BED_CENTER_ID, UI_ACTION_SET_BED_CENTER)

UI_MENU_ACTIONCOMMAND_FILTER_T(ui_endstop_y, UI_TEXT_ENDSTOP_Y_ID, UI_ACTION_ENDSTOP_Y, 0, MENU_MODE_PRINTING)
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_endstop_x, UI_TEXT_ENDSTOP_X_ID, UI_ACTION_ENDSTOP_X, 0, MENU_MODE_PRINTING)



#define UI_MENU_BED_OFF {UI_MENU_ADDCONDBACK &ui_menu_go_offsets, &ui_menu_quick_origin,&ui_menu_set_bed_center}
UI_MENU(ui_menu_bed_offset, UI_MENU_BED_OFF, 3 + UI_MENU_BACKCNT) 
UI_MENU_SUBMENU_T(ui_menu_bed_off, UI_TEXT_BED_OFF_ID, ui_menu_bed_offset)

#define UI_MENU_STEP_CAL {UI_MENU_ADDCONDBACK &ui_menu_x_step, &ui_menu_y_step, &ui_menu_z_step, &ui_menu_e_step}
UI_MENU(ui_menu_step_calibration, UI_MENU_STEP_CAL, 5 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_step_cal, UI_TEXT_STEP_CAL_ID, ui_menu_step_calibration)
...
#define UI_MENU_TEMP {UI_MENU_ADDCONDBACK UI_MENU_EXTCOND}
UI_MENU(ui_temp_menu, UI_MENU_TEMP, UI_MENU_BACKCNT  + UI_MENU_EXTCNT)
UI_MENU_SUBMENU_T(ui_menu_temp, UI_TEXT_TEMP_ID, ui_temp_menu)

#define UI_MENU_PREHEAT {UI_MENU_ADDCONDBACK &ui_menu_quick_preheat_pla,&ui_menu_quick_preheat_abs}
UI_MENU(ui_menu_preheat_extr, UI_MENU_PREHEAT, UI_MENU_BACKCNT + 2)
UI_MENU_SUBMENU_T(ui_menu_preheat, UI_TEXT_PREHEAT_ID, ui_menu_preheat_extr)
UI_MENU_ACTIONCOMMAND_T(ui_menu_quick_cooldown, UI_TEXT_COOLDOWN_ID, UI_ACTION_COOLDOWN | UI_ACTION_TOPMENU)
...
#define UI_MENU_ROTX {UI_MENU_ADDCONDBACK &ui_menu_rot_x_fast,&ui_menu_rotate_xfast_notest,&ui_menu_rotate_x_notest,&ui_endstop_x,&ui_menu_set_shoulder_origin,&ui_menu_set_bed_center}
UI_MENU(ui_menu_rot_x_pos, UI_MENU_ROTX, 6 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_rot_x, UI_TEXT_ROTX_ID, ui_menu_rot_x_pos)
#if MAX_HARDWARE_ENDSTOP_Z
#define UI_MENU_MOVE_Z {UI_MENU_ADDCONDBACK &ui_menu_move_z_fast,&ui_menu_go_zfast_notest,&ui_menu_go_zpos_notest,&ui_menu_home_z,&ui_menu_set_measured_origin}
#else
#define UI_MENU_MOVE_Z {UI_MENU_ADDCONDBACK &ui_menu_move_z_fast,&ui_menu_go_zfast_notest,&ui_menu_go_zpos_notest,&ui_menu_home_z}
#endif
UI_MENU(ui_menu_move_z_pos, UI_MENU_MOVE_Z, 5 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_move_z, UI_TEXT_MOVEZ_ID, ui_menu_move_z_pos)
#define UI_MENU_MOVE_Y {UI_MENU_ADDCONDBACK &ui_menu_move_y_fast,&ui_menu_go_ypos,&ui_menu_home_y,&ui_menu_set_bed_center}
UI_MENU(ui_menu_move_y_pos, UI_MENU_MOVE_Y, 4 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_move_y, UI_TEXT_MOVEY_ID, ui_menu_move_y_pos)
#define UI_MENU_MOVE_X {UI_MENU_ADDCONDBACK &ui_menu_move_x_fast,&ui_menu_go_xpos,&ui_menu_home_x,&ui_menu_set_bed_center}
UI_MENU(ui_menu_move_x_pos, UI_MENU_MOVE_X, 4 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_move_x, UI_TEXT_MOVEX_ID, ui_menu_move_x_pos)
#else
#if MAX_HARDWARE_ENDSTOP_Z
#define UI_MENU_MOVE_Z {UI_MENU_ADDCONDBACK &ui_menu_move_z_fast,&ui_menu_go_zfast_notest,&ui_menu_go_zpos_notest,&ui_menu_home_z,&ui_menu_set_measured_origin}
#else
...
UI_MENU(ui_menu_move_z_pos, UI_MENU_MOVE_Z, 5 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_move_z, UI_TEXT_MOVEZ_ID, ui_menu_move_z_pos)
#define UI_MENU_MOVE_Y {UI_MENU_ADDCONDBACK &ui_menu_move_y_fast,&ui_menu_go_ypos,&ui_menu_home_y}
UI_MENU(ui_menu_move_y_pos, UI_MENU_MOVE_Y, 3 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_move_y, UI_TEXT_MOVEY_ID, ui_menu_move_y_pos)
#define UI_MENU_MOVE_X {UI_MENU_ADDCONDBACK &ui_menu_move_x_fast,&ui_menu_go_xpos,&ui_menu_home_x}
UI_MENU(ui_menu_move_x_pos, UI_MENU_MOVE_X, 3 + UI_MENU_BACKCNT)
UI_MENU_SUBMENU_T(ui_menu_move_x, UI_TEXT_MOVEX_ID, ui_menu_move_x_pos)
#endif	
...
// Switch off sub menu
UI_MENU_ACTIONCOMMAND_FILTER_T(ui_close_arm, UI_TEXT_CLOSE_ARM_ID, UI_ACTION_CLOSE_ARM, 0, MENU_MODE_PRINTING)
...
#define UI_SPEED_MENU_ID {UI_MENU_ADDCONDBACK &ui_menu_quick_speedmultiply,&ui_menu_quick_flowmultiply, UI_MENU_FAN_COND}
UI_MENU(ui_speed_menu, UI_SPEED_MENU_ID, 2 + UI_MENU_BACKCNT + UI_MENU_FAN_CNT)
#define UI_ADJUST_MENU_ID {UI_MENU_ADDCONDBACK BABY_ENTRY UI_MENU_COATING_COND}
...
#else
#define UI_MENU_MOVE_ID {UI_MENU_ADDCONDBACK &ui_menu_home_all, &ui_menu_move_x, &ui_menu_move_y, &ui_menu_move_z, &ui_menu_step_cal, &ui_menu_bed_off SERVOPOS_ENTRY}
UI_MENU(ui_move_menu, UI_MENU_MOVE_ID, 6 + UI_MENU_BACKCNT + SERVOPOS_COUNT)
#endif
...
#else 
#define UI_MENU_SWITCH_OFF_ID {UI_MENU_ADDCONDBACK &ui_menu_quick_stopstepper, &ui_menu_quick_power}
UI_MENU(ui_menu_switch_off, UI_MENU_SWITCH_OFF_ID, 2 + UI_MENU_BACKCNT) 
#endif

UI_MENU_SUBMENU_T(ui_menu_speed, UI_TEXT_SPEED_MENU_ID, ui_speed_menu)
UI_MENU_SUBMENU_T(ui_menu_adj, UI_TEXT_ADJ_MENU_ID, ui_adjust_menu)
UI_MENU_SUBMENU_T(ui_menu_film, UI_TEXT_FILM_MENU_ID, ui_film_menu)
UI_MENU_SUBMENU_T(ui_menu_move, UI_TEXT_MOVE_ID, ui_move_menu)
UI_MENU_SUBMENU_T(ui_menu_config, UI_TEXT_CONFIGURATION_ID, ui_menu_configuration)
UI_MENU_SUBMENU_T(ui_menu_turnoff, UI_TEXT_SWITCH_OFF_ID, ui_menu_switch_off)

#define UI_MENU_MAIN {UI_MENU_ADDCONDBACK UI_MENU_SD_COND &ui_menu_speed, &ui_menu_adj, &ui_menu_film, &ui_menu_move, &ui_menu_config, &ui_menu_turnoff}
UI_MENU(ui_menu_main, UI_MENU_MAIN, 6 + UI_MENU_BACKCNT + UI_MENU_SD_CNT)
