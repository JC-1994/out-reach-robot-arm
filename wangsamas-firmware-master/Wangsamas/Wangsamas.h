...
extern uint8_t TransformToBedCenter(float tempx1, float tempy1, float &tempx2, float &tempy2);	// Kusuma SCARA
extern uint8_t transformScaraStepsToCartesianSteps(long scaraPosSteps[], long cartesianPosSteps[]); // Kusuma SCARA
#endif																			// Kusuma Scara
#if NONLINEAR_SYSTEM
