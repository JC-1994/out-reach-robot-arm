...
#define FIRMWARE_URL " "
#endif // FIRMWARE_URL
FSTRINGVALUE(Com::tFirmware,"FIRMWARE_NAME:Repetier_" WANGSAMAS_VERSION " FIRMWARE_URL:" FIRMWARE_URL " PROTOCOL_VERSION:1.0 MACHINE_TYPE:" MACHINE_TYPE " EXTRUDER_COUNT:" XSTR(NUM_EXTRUDER) " WANGSAMAS_PROTOCOL:3")
...
FSTRINGVALUE(Com::tElbowMinAngle,"Elbow minimum angle (deg):")						// Kusuma SCARA
FSTRINGVALUE(Com::tShoulderMaxAngle,"Shoulder maximum rotation (deg):")			// Kusuma SCARA
FSTRINGVALUE(Com::tElbowMaxAngle,"Elbow maximum rotation (deg):")				// Kusuma SCARA
FSTRINGVALUE(Com::tShoulderBedCenterAngle,"Shoulder angle at bed center (deg):")	// Kusuma SCARA
FSTRINGVALUE(Com::tElbowBedCenterAngle,"Elbow angle at bed center (deg):")			// Kusuma SCARA
#endif																				// Kusuma SCARA
#if DRIVE_SYSTEM==DELTA
...
FSTRINGVALUE(Com::tEPRZStepsPerUnit,"steps per unit")
...
FSTRINGVALUE(Com::tEPRXStepsPerUnit,"X-axis steps per unit")
FSTRINGVALUE(Com::tEPRYStepsPerUnit,"Y-axis steps per unit")
FSTRINGVALUE(Com::tEPRZStepsPerUnit,"Z-axis steps per unit")
...
FSTRINGVALUE(Com::tEPRStepsPerUnit,"steps per unit")
